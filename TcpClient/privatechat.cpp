...
void PrivateChat::updateMsg(const PDU *pdu)
{
    ...
    QString strMsg = QString("%1 says %2").arg(caSendName).arg(pdu->caMsg);
...
void PrivateChat::on_sendMsg_pb_clicked()
{
    ...
    if(!strMsg.isEmpty()){
        ...
        QString strDisplay = QString("%1 says : %2").arg(m_strLoginName).arg(strMsg);
        ui->showMsg_te->append(strDisplay);
        ...
        QMessageBox::warning(this,"private chat","is not null");
    }
}
